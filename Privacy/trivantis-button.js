...
function ObjButtonBuild() {
  ...
  this.divInt += '<button type="button" name="'+this.name+'btn" id="'+this.name+'btn" tabindex="' + (this.tabIdx ? this.tabIdx : this.z) +'"'
...
{	
	...
	txtReturn += "<image xlink:href=\""+ this.tdD + "\" x=\"0\" y=\"0\" width=\"" + adjustedWidth + "\" height=\""+adjustedHeight +  "\" preserveAspectRatio=\"none\">\n";
	txtReturn += "</pattern>\n";
	...
	txtReturn += "<image xlink:href=\""+ this.tdDi + "\" x=\"0\" y=\"0\" width=\"" + adjustedWidth + "\" height=\""+adjustedHeight +  "\" preserveAspectRatio=\"none\">\n";
	txtReturn += "</pattern>\n";
